...
var tData= require('../mock/tree.json');
var homeData = require('../mock/home.json');
var content = require('../mock/article.json');
var weather = require('../mock/weather.json');
var foods = require('../mock/food.json');
var tree = tData.name;

var apiRoutes = express.Router();


apiRoutes.get('/tree',function(req,res){
 res.send(tData)
});
